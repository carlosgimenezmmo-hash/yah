...
export default function LandingPage() {
  ...
  🚀 VERSION 2.0<br /><span style={{ color: "#22C55E" }}>El primer marketplace inmobiliario en video</span>
</h1>
      ...
      <section style={{ padding: "80px 24px", background: "#fff" }}>
        <div style={{ maxWidth: 1000, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 20 }}>
            {apps.map((app) => (
              <div key={app.nombre} onClick={() => app.disponible && window.location.assign(app.href) } style={{ padding: 28, borderRadius: 20, border: `1px solid ${app.border}`, background: app.bg, cursor: app.disponible ? "pointer" : "default", position: "relative", opacity: app.disponible ? 1 : 0.6 }}>
                {!app.disponible && (
